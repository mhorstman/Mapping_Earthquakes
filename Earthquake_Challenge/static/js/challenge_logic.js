...
// Define the links for the source data
var usgsEarthquakes = "https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson"
var platesBoundries = "https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json"
var usgsMajorEarthquakes = "https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_week.geojson"
...
d3.json(usgsEarthquakes).then(function(data) {
  ...
  d3.json(usgsMajorEarthquakes).then(function(data) {
...
// Looping through our intervals to generate a label with a colored square for each interval.
  ...
  d3.json(platesBoundries).then(function(data) {
    console.log(data);
    L.geoJson(data, {
      color: "blue",
      weight: 2,
